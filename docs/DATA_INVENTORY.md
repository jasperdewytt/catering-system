...
- **Structural quirks**: The three minimum columns are not normalised — they imply a `(caterer, menu_item_count, min_meals)` shape that may want flattening during ingestion. The "menu item count" presumably means the number of distinct dishes the operator chooses to offer that week. See [E-17](EDGE_CASES.md#e-17-meaning-of-menu-item-count).
